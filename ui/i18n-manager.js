...
export function createI18NManager({ data, fallbackLocale = "en" }) {
  ...
  function applyTranslations(els) {
    ...
    setText(els.feedbackTitle, t("modal.feedbackTitle"));
    setText(els.feedbackIntro, t("modal.feedbackIntro"));
    setText(els.feedbackTextLabel, t("modal.feedbackTextLabel"));
    ...
    setText(els.feedbackEmailBtn, t("options.emailFeedback"));
    setText(els.feedbackTelegramBtn, t("options.telegramFeedback"));
    setText(els.feedbackCopyBtn, t("options.copyFeedback"));
    ...
    els.feedbackBtn.setAttribute("aria-label", t("aria.feedbackBtn"));
    ...
    els.closeFeedbackModalBtn.setAttribute("aria-label", t("aria.close"));
    els.closeResetConfirmModalBtn.setAttribute("aria-label", t("aria.close"));
    els.feedbackText.setAttribute("placeholder", t("feedback.placeholder"));
  }
